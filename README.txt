...
a persistence unit "BancaVirtualFinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancaVirtualFinal\pom.xml":
...
artifact ("BancaVirtualFinal.war") is already built. You can build
